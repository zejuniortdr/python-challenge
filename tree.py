...
class Tree:
	...
	def _print_tree(self,current_node):
		if current_node:
			...
			print('{} => [ left: {}, right: {}, parent: {}]'.format(current_node.value, current_node.left, current_node.right))
...
def search(T):
	...
	limit_input = str(input("Digite a quantidade de registros que deseja [default: {}]: ".format(LIMITE_PADRAO)))
	limit = LIMITE_PADRAO
	if limit_input:
